...
namespace Pulumi.Multihook
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Multihook.version.txt");
    ...
    internal sealed class MultihookResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public MultihookResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
